 ...
 * @author title
 */
public class ImportBackup extends javax.swing.JDialog {

    /**
     * Creates new form ImportBackup
     */
    public ImportBackup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initSettings();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImportBackup dialog = new ImportBackup(new javax.swing.JFrame(), true);
